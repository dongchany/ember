# Tutorial #10 Prompt (Full, With Code + Reports)
...
```text
我正在为我的开源项目 Ember 写一个系列教程。请帮我写第 10 篇。
...
### File: docs/sampler_explanation.md
...
### File: apps/ember_cli/main.cpp (sampler usage in CLI)
...
### Report: reports/stage22_numeric_consistency_4b_20260225_mainline/stage22_summary.md

````md
# Stage 2.2 Numeric Consistency

- Model: `/home/dong/xilinx/huggingface/hub/models--Qwen--Qwen3-4B-Instruct-2507/snapshots/cdbee75f17c01a7cc42f958dc650907174af0554`
- Setting: prompt_len=128, gen_len=32, num_candidates=4, gpus=0,1, split=9,27
- Generated at: `2026-02-25T13:18:51`

| check | ok | token_mismatch_candidates | finish_reason_mismatch_candidates | max_abs_logprob_diff | mean_abs_logprob_diff |
| --- | --- | --- | --- | --- | --- |
| same_seed_repro | 1 | 0 | 0 | 0.00000000 | 0.00000000 |
| seed_plus_1_diff | 1 | 4 | 0 | 4.75196700 | 1.18575816 |
